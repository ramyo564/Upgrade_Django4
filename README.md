...
- 5. [기능 구현 이미지](https://github.com/ramyo564/Upgrade_Django4/edit/main/README.md#5-%EA%B8%B0%EB%8A%A5-%EA%B5%AC%ED%98%84-%EC%9D%B4%EB%AF%B8%EC%A7%80)
- 6. [회고](https://github.com/ramyo564/Upgrade_Django4/edit/main/README.md#6-%ED%9A%8C%EA%B3%A0)
...
- 서버 환경 설정과 클라우드 플랫폼인 AWS를 다루는 것을 어떻게 해야 할지 감이 안 왔고, 에러 메시지와 로그 확인조차 방법을 찾아야 했습니다.     

- 처음에는 이해할 수 있는 게 거의 없어서 힘들었지만, 이해가 갈 때까지 지속적인 구글링을 하고 이해한 내용이 맞는지 가설을 세우고 실험하는 과정에서 즐거움과 성취감을 느낄 수 있었습니다.      

- 가설을 세우고 문제를 해결했던 경험 중에는 AWS에서 PostgresSQL로 db를 변경했을 당시 기존에 SQLite3에서 개발하면서 만들었던 데이터를 안전하게 옮긴 경험이 있습니다.      

예를 들어서 이런 식으로 가설을 세웠습니다.
 ...
 **해결 과정**:
- SQLite3에서 데이터를 PostgreSQL로 이동하려면 데이터베이스의 내용을 JSON 형식으로 추출한다.
- 추출한 JSON 데이터를 로컬 환경에서 AWS 클라우드의 PostgreSQL 데이터베이스에 연결하여 데이터를 적용한다.
