...
ALLOWED_HOSTS = ['django-greatkart-env-7.eba-fdvmcepg.ap-northeast-2.elasticbeanstalk.com',"yohanyohan.com","*"]
# ALLOWED_HOSTS = ['django-greatkart-env-7.eba-fdvmcepg.ap-northeast-2.elasticbeanstalk.com',"*"]
